          ...
          <div className="lg:col-span-2">
            {prediction ? (
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <ul className="space-y-1">
                        {prediction.prediction.risks?.map(
                    ...
                    <div>
                      ...
                      <ul className="space-y-1">
                        {prediction.prediction.recommendations?.map(
                          (rec: string, i: number) => (
                            <li key={i} className="flex gap-2 text-sm">
                              <CheckCircle
                                size={18}
                  ...
                  <div className="space-y-2">
                    {prediction.sources?.slice(0, 3).map((source: any, i: number) => (
                      <div key={i} className="bg-gray-50 p-3 rounded text-sm">
                        <p className="font-semibold text-climate-primary">
                          {source.source}
                        </p>
              ...
              <div className="card text-center py-12">
                <p className="text-gray-600">
                  Select a city and click 'Get Prediction' to analyze health risks
                </p>
              </div>
            )}
          </div>
