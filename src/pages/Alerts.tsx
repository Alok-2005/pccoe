...
export default function Alerts() {
  ...
  const getSeverityColor = (severity: string) => {
    ...
    if (severity === "medium") return "border-l-blue-500 bg-blue-50";
            ...
            {alerts.map((alert) => (
              <div
                ...
                className={`card border-l-4 ${getSeverityColor(alert.severity)} ${
                  !alert.read ? "ring-2 ring-climate-primary" : ""
                }`}
              >
        ...
        <div className="card mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-blue-50 p-4 rounded">
              <p className="font-semibold text-climate-primary mb-1">
                🌡️ High Temperature Alert
              </p>
              <p className="text-sm text-gray-700">
                Stay indoors during peak hours (10 AM - 4 PM). Drink water
                regularly.
              </p>
            </div>

            <div className="bg-orange-50 p-4 rounded">
              <p className="font-semibold text-climate-warning mb-1">
                💨 Poor Air Quality
              </p>
              <p className="text-sm text-gray-700">
                Wear N95 masks outdoors. Use air purifiers indoors.
              </p>
            </div>

            <div className="bg-blue-50 p-4 rounded">
              <p className="font-semibold text-blue-600 mb-1">☀️ High UV Index</p>
              <p className="text-sm text-gray-700">
                Apply SPF 30+ sunscreen. Wear hats and sunglasses.
              </p>
            </div>
            ...
            <div className="bg-green-50 p-4 rounded">
              ...
              <p className="text-sm text-gray-700">
                Maintain hygiene. Use mosquito nets. Report symptoms early.
              </p>
            </div>
          </div>
        </div>
